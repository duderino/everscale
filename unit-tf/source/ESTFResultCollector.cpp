 ...
 */
void ResultCollector::merge(const ResultCollector *collector) {
 ...
 */
std::ostream &ResultCollector::print(std::ostream &output) const {
  /** @todo print header. */
 ...
 *  @return The output stream (for chaining).
 */
std::ostream &ResultCollector::Result::print(std::ostream &output) const {
  switch (_type) {
    case Success:
      output << "Success,";
      break;
