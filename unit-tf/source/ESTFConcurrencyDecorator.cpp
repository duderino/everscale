...
ConcurrencyDecorator::ConcurrencyDecorator(ComponentPtr &component, int threads)
    : Component(), _component(component), _threads(threads) {}

ConcurrencyDecorator::~ConcurrencyDecorator() {}

bool ConcurrencyDecorator::run(ResultCollector *collector) {
  int i = 0;
  bool result = true;
...
bool ConcurrencyDecorator::setup() { return _component->setup(); }

bool ConcurrencyDecorator::tearDown() { return _component->tearDown(); }
