...
bool RepetitionDecorator::run(ResultCollector *collector) {
...
bool RepetitionDecorator::setup() { return _component->setup(); }

bool RepetitionDecorator::tearDown() { return _component->tearDown(); }
