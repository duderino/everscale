...
ESB::UInt16 HttpUtil::_Bitmasks[] = {
    ...
    /* 0x */ 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    0x0000,          0x0300, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* 1x */ 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    0x0000,          0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    /* 2x */ 0x0300, 0x0508, 0x0300, 0x0500, 0x05C0, 0x0520, 0x05C0, 0x0508,
    0x0308,          0x0308, 0x0508, 0x05C0, 0x03C0, 0x0508, 0x0508, 0x0380,
    /* 3x */ 0x0504, 0x0504, 0x0504, 0x0504, 0x0504, 0x0504, 0x0504, 0x0504,
    0x0504,          0x0504, 0x03C0, 0x0380, 0x0300, 0x03C0, 0x0300, 0x0380,
    /* 4x */ 0x03C0, 0x0512, 0x0512, 0x0512, 0x0512, 0x0512, 0x0512, 0x0502,
    0x0502,          0x0502, 0x0502, 0x0502, 0x0502, 0x0502, 0x0502, 0x0502,
    /* 5x */ 0x0502, 0x0502, 0x0502, 0x0502, 0x0502, 0x0502, 0x0502, 0x0502,
    0x0502,          0x0502, 0x0502, 0x0300, 0x0300, 0x0300, 0x0500, 0x0508,
    /* 6x */ 0x0500, 0x0511, 0x0511, 0x0511, 0x0511, 0x0511, 0x0511, 0x0501,
    0x0501,          0x0501, 0x0501, 0x0501, 0x0501, 0x0501, 0x0501, 0x0501,
    /* 7x */ 0x0501, 0x0501, 0x0501, 0x0501, 0x0501, 0x0501, 0x0501, 0x0501,
    0x0501,          0x0501, 0x0501, 0x0300, 0x0500, 0x0300, 0x0508, 0x0000,
    /* 8x */ 0x0100, 0x0100, 0x0100, 0x0100, 0x0100, 0x0100, 0x0100, 0x0100,
    0x0100,          0x0100, 0x0100, 0x0100, 0x0100, 0x0100, 0x0100, 0x0100,
    /* 9x */ 0x0100, 0x0100, 0x0100, 0x0100, 0x0100, 0x0100, 0x0100, 0x0100,
    0x0100,          0x0100, 0x0100, 0x0100, 0x0100, 0x0100, 0x0100, 0x0100,
    /* Ax */ 0x0100, 0x0100, 0x0100, 0x0100, 0x0100, 0x0100, 0x0100, 0x0100,
    0x0100,          0x0100, 0x0100, 0x0100, 0x0100, 0x0100, 0x0100, 0x0100,
    /* Bx */ 0x0100, 0x0100, 0x0100, 0x0100, 0x0100, 0x0100, 0x0100, 0x0100,
    0x0100,          0x0100, 0x0100, 0x0100, 0x0100, 0x0100, 0x0100, 0x0100,
    /* Cx */ 0x0100, 0x0100, 0x0100, 0x0100, 0x0100, 0x0100, 0x0100, 0x0100,
    0x0100,          0x0100, 0x0100, 0x0100, 0x0100, 0x0100, 0x0100, 0x0100,
    /* Dx */ 0x0100, 0x0100, 0x0100, 0x0100, 0x0100, 0x0100, 0x0100, 0x0100,
    0x0100,          0x0100, 0x0100, 0x0100, 0x0100, 0x0100, 0x0100, 0x0100,
    /* Ex */ 0x0100, 0x0100, 0x0100, 0x0100, 0x0100, 0x0100, 0x0100, 0x0100,
    0x0100,          0x0100, 0x0100, 0x0100, 0x0100, 0x0100, 0x0100, 0x0100,
    /* Fx */ 0x0100, 0x0100, 0x0100, 0x0100, 0x0100, 0x0100, 0x0100, 0x0100,
    0x0100,          0x0100, 0x0100, 0x0100, 0x0100, 0x0100, 0x0100, 0x0100};
...
bool HttpUtil::EndsWith(const char *str, int strLength, const char *pattern, int patternLength) {
  if (!str || !pattern) {
    return false;
  }
...
ESB::Error HttpUtil::ParseInteger(unsigned const char *str, ESB::UInt64 *integer) {
  if (!str || !integer) {
    return ESB_NULL_POINTER;
  }
...
ESB::Error HttpUtil::FormatInteger(ESB::Buffer *buffer, ESB::UInt64 integer, int radix) {
  if (!buffer) {
    return ESB_NULL_POINTER;
  }
