...
ESB::Error HttpRequestUriParser::parseAsterisk(ESB::Buffer *inputBuffer, HttpRequestUri &requestUri) {
  ...
  requestUri.setType(HttpRequestUri::UriType::ES_HTTP_URI_ASTERISK);
    ...
    switch (octet) {
      ...
      case ':':
        ...
        if (_workingBuffer->match(HTTP)) {
          ...
          requestUri.setType(HttpRequestUri::UriType::ES_HTTP_URI_HTTPS);
          ...
          requestUri.setType(HttpRequestUri::UriType::ES_HTTP_URI_OTHER);
