...
AWSHttpTransaction::AWSHttpTransaction(ESFCleanupHandler *cleanupHandler)
    : _allocator(AWS_HTTP_TRANSACTION_ALLOCATOR_CHUNK_SIZE,
...
AWSHttpTransaction::AWSHttpTransaction(ESFSocketAddress *peerAddress,
...
AWSHttpHeader *AWSHttpTransaction::createHeader(unsigned const char *name,
  ...
  AWSHttpHeader *header =
      new (&_allocator) AWSHttpHeader(fieldName, fieldValue);
