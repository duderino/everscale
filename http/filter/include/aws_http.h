 ...
 * @return a result code
 */
typedef aws_http_server_handler_result (*aws_http_server_handler_receive_request_headers)(
 ...
 */
typedef void (*aws_http_server_handler_fill_response_chunk)(aws_http_transaction transaction, unsigned char *chunk,
                                                            unsigned int chunkSize);
...
typedef int (*aws_http_logger)(void *log_context, aws_http_log_level level, const char *file, int line,
...
extern aws_http_stack aws_http_stack_create(aws_http_server *server, const aws_http_server_config *server_config,
 ...
 */
typedef void (*aws_http_client_handler_fill_request_chunk)(aws_http_transaction transaction, unsigned char *chunk,
                                                           unsigned int chunkSize);
 ...
 * @return a result code
 */
typedef aws_http_client_handler_result (*aws_http_client_handler_receive_response_headers)(
    aws_http_transaction transaction);
 ...
 * @return a result code
 */
typedef aws_http_client_handler_result (*aws_http_client_handler_receive_response_body)(
    aws_http_transaction transaction, unsigned const char *chunk, unsigned int chunkSize);
typedef enum {
 ...
 * any other state indicates error - reason will be in the server logs.
 */
typedef void (*aws_http_client_handler_end_transaction)(aws_http_transaction transaction,
                                                        aws_http_client_handler_state state);
 ...
 */
extern aws_http_transaction aws_http_stack_create_client_transaction(aws_http_stack stack, aws_http_client *client,
                                                                     void *client_context);
 ...
 */
extern int aws_http_stack_execute_client_transaction(aws_http_stack stack, aws_http_transaction transaction);
...
extern int aws_http_header_set_field_name(aws_http_message message, aws_http_header header,
                                          const unsigned char *field_name);
extern const unsigned char *aws_http_header_get_field_value(const aws_http_header header);
extern int aws_http_header_set_field_value(aws_http_message message, aws_http_header header,
...
extern int aws_http_message_append_header(aws_http_message message, const unsigned char *field_name,
                                          const unsigned char *field_value, aws_http_transaction transaction);
extern int aws_http_message_prepend_header(aws_http_message message, const unsigned char *field_name,
                                           const unsigned char *field_value, aws_http_transaction transaction);
