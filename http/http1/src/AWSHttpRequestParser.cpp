...
AWSHttpRequestParser::AWSHttpRequestParser(ESFBuffer *workingBuffer,
...
ESFError AWSHttpRequestParser::parseStartLine(ESFBuffer *inputBuffer,
...
ESFError AWSHttpRequestParser::parseMethod(ESFBuffer *inputBuffer,
