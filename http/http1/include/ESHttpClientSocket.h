...
class HttpClientSocket : public ESB::MultiplexedSocket {
 ...
 private:
  ...
  ESB::Error parseResponseHeaders(ESB::Flag *isRunning, ESB::Logger *logger);

  ESB::Error parseResponseBody(ESB::Flag *isRunning, ESB::Logger *logger);

  ESB::Error formatRequestHeaders(ESB::Flag *isRunning, ESB::Logger *logger);

  ESB::Error formatRequestBody(ESB::Flag *isRunning, ESB::Logger *logger);
