...
extern const unsigned char *aws_http_header_get_field_value(aws_http_stack stack,
                                                            aws_http_header header);
extern int aws_http_header_set_field_value(aws_http_stack stack,
                                           aws_http_header header,
                                           const unsigned char *field_value);

extern aws_http_header aws_http_message_get_first_header(aws_http_stack stack,
                                                         aws_http_message message);
extern aws_http_header aws_http_message_get_next_header(aws_http_stack stack,
                                                        aws_http_message message,
                                                        aws_http_header header);
...
extern void aws_http_request_reset(aws_http_connection connection,
                                   aws_http_request request);
extern const unsigned char *aws_http_request_get_method(aws_http_connection connection,
                                                        aws_http_request request);
