...
AWSHttpRequest *AWSHttpApi::createRequest()
{
    todo
}

void AWSHttpApi::destroyRequest(AWSHttpRequest *request)
{
    todo
}
...
void AWSHttpApi::destroyResponse(AWSHttpResponse *AWSHttpApi::response)
{
    todo
}
