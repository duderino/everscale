...
#define AWS_HTTP_LISTENING_SOCKET_H
...
/** A listening socket that creates AWSHttpServerSockets
 */
class AWSHttpListeningSocket : public ESFMultiplexedSocket
{
public:
     ...
     * @param allocator An allocator that will allocate new AWSHttpServerSockets
     ...
     * @param socketCleanupHandler A cleanup handler for all AWSHttpServerSockets created by
     *  this object.
     */
    AWSHttpListeningSocket(AWSHttpServerHandler *handler,
    ...
    /** Destructor.
     */
    virtual ~AWSHttpListeningSocket();
...
private:
    // Disabled
    AWSHttpListeningSocket(const AWSHttpListeningSocket &);
    AWSHttpListeningSocket &operator=(const AWSHttpListeningSocket &);
...
#endif /* ! AWS_HTTP_LISTENING_SOCKET_H */
