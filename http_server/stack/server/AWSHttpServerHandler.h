...
class AWSHttpServerHandler {
 public:
  typedef enum {
    AWS_HTTP_SERVER_HANDLER_CONTINUE =
  ...
  typedef enum {
    ...
    AWS_HTTP_SERVER_HANDLER_END =
        5 /**< Response sent / transaction completed */
  } State;
   ...
   * AWS_HTTP_SERVER_HANDLER_END means the transaction was successfully
