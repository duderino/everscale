...
ESFError AWSHttpRequestFormatter::formatStartLine(
  ...
  if (AWS_FORMATTING_METHOD & _requestState) {
    ...
    AWSHttpUtil::Transition(&_requestState, outputBuffer, AWS_FORMATTING_METHOD,
                            AWS_FORMATTING_REQUEST_URI);
  }
  ...
  if (AWS_FORMATTING_REQUEST_URI & _requestState) {
    ...
    AWSHttpUtil::Transition(&_requestState, outputBuffer,
                            AWS_FORMATTING_REQUEST_URI,
                            AWS_FORMATTING_HTTP_VERSION);
  }
  ...
  if (AWS_FORMATTING_HTTP_VERSION & _requestState) {
    ...
    return AWSHttpUtil::Transition(&_requestState, outputBuffer,
                                   AWS_FORMATTING_HTTP_VERSION,
                                   AWS_FORMAT_COMPLETE);
  }
...
ESFError AWSHttpRequestFormatter::formatMethod(ESFBuffer *outputBuffer,
                                               const AWSHttpRequest *request) {
