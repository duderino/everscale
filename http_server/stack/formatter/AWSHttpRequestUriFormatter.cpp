...
void AWSHttpRequestUriFormatter::reset()
{
    _state = 0x00;
}

ESFError AWSHttpRequestUriFormatter::format(ESFBuffer *outputBuffer, const AWSHttpRequestUri *requestUri)
{
    ...
    if (0x00 == _state)
    {
        ...
        switch (requestUri->getType())
        {
            ...
            case AWSHttpRequestUri::AWS_URI_HTTPS:
                ...
                {
                    AWSHttpUtil::Start(&_state, outputBuffer, AWS_URI_FORMATTING_ABS_PATH);
                }
            ...
            case AWSHttpRequestUri::AWS_URI_OTHER:
                ...
                AWSHttpUtil::Start(&_state, outputBuffer, AWS_URI_FORMATTING_NON_HTTP_URI);
...
ESFError AWSHttpRequestUriFormatter::formatAsterisk(ESFBuffer *outputBuffer, const AWSHttpRequestUri *requestUri)
{
    // "*"
    ...
    return AWSHttpUtil::Transition(&_state, outputBuffer, AWS_URI_FORMATTING_ASTERISK, AWS_URI_FORMAT_COMPLETE);
}

ESFError AWSHttpRequestUriFormatter::formatAbsPath(ESFBuffer *outputBuffer, const AWSHttpRequestUri *requestUri)
{
    ...
    const unsigned char *p = 0 == requestUri->getAbsPath() ?
                             (const unsigned char *) "/" : requestUri->getAbsPath();
    ...
    return AWSHttpUtil::Transition(&_state, outputBuffer, AWS_URI_FORMATTING_ABS_PATH, AWS_URI_FORMATTING_QUERY);
}

ESFError AWSHttpRequestUriFormatter::formatQuery(ESFBuffer *outputBuffer, const AWSHttpRequestUri *requestUri)
{
    // query         = *uric
    ...
    if (! p || 0 == *p)
    {
        return AWSHttpUtil::Transition(&_state, outputBuffer, AWS_URI_FORMATTING_QUERY, AWS_URI_FORMATTING_FRAGMENT);
    }
...
ESFError AWSHttpRequestUriFormatter::formatFragment(ESFBuffer *outputBuffer, const AWSHttpRequestUri *requestUri)
{
    // fragment         = *uric
    ...
    if (! p || 0 == *p)
    {
        return AWSHttpUtil::Transition(&_state, outputBuffer, AWS_URI_FORMATTING_FRAGMENT, AWS_URI_FORMAT_COMPLETE);
    }
...
ESFError AWSHttpRequestUriFormatter::formatScheme(ESFBuffer *outputBuffer, const AWSHttpRequestUri *requestUri)
{
    ...
    switch (requestUri->getType())
    {
        ...
        case AWSHttpRequestUri::AWS_URI_OTHER:
            ...
            return AWSHttpUtil::Transition(&_state, outputBuffer, AWS_URI_FORMATTING_SCHEME, AWS_URI_FORMATTING_HOST);

        default:

            return AWSHttpUtil::Rollback(outputBuffer, AWS_HTTP_BAD_REQUEST_URI_SCHEME);
    }
...
ESFError AWSHttpRequestUriFormatter::formatHost(ESFBuffer *outputBuffer, const AWSHttpRequestUri *requestUri)
{
    ...
    ESF_ASSERT(AWSHttpRequestUri::AWS_URI_HTTP == requestUri->getType() || AWSHttpRequestUri::AWS_URI_HTTPS == requestUri->getType());
    ...
    return AWSHttpUtil::Transition(&_state, outputBuffer, AWS_URI_FORMATTING_HOST, AWS_URI_FORMATTING_PORT);
}


ESFError AWSHttpRequestUriFormatter::formatPort(ESFBuffer *outputBuffer, const AWSHttpRequestUri *requestUri)
{
    // port          = *digit
    ...
    switch (requestUri->getType())
    {
        case AWSHttpRequestUri::AWS_URI_HTTP:
            ...
            if (0 > port || 80 == port)
            {
                return AWSHttpUtil::Transition(&_state, outputBuffer, AWS_URI_FORMATTING_PORT, AWS_URI_FORMATTING_ABS_PATH);
            }
...
ESFError AWSHttpRequestUriFormatter::formatNonHttpUri(ESFBuffer *outputBuffer, const AWSHttpRequestUri *requestUri)
{
    // absoluteURI   = scheme ":" ( hier_part | opaque_part )
    ...
    return AWSHttpUtil::Transition(&_state, outputBuffer, AWS_URI_FORMATTING_NON_HTTP_URI, AWS_URI_FORMAT_COMPLETE);
}
