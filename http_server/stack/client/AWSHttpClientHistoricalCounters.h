...
public:
     ...
     */
    AWSHttpClientHistoricalCounters(time_t windowSizeSec, ESFAllocator *allocator, ESFLogger *logger);
...
private:
    // Disabled
    AWSHttpClientHistoricalCounters(const AWSHttpClientHistoricalCounters &counters);
