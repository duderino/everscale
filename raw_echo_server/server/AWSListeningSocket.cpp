...
AWSListeningSocket::AWSListeningSocket(ESFListeningTCPSocket *socket,
...
bool AWSListeningSocket::wantAccept()
{
    return true;
}

bool AWSListeningSocket::wantConnect()
{
    return false;
}

bool AWSListeningSocket::wantRead()
{
    return false;
}

bool AWSListeningSocket::wantWrite()
{
    return false;
}

bool AWSListeningSocket::isIdle()
{
    return false;
}

bool AWSListeningSocket::handleAcceptEvent(ESFFlag *isRunning, ESFLogger *logger)
{
    ESF_ASSERT(_socket);
    ...
    AWSServerSocket *serverSocket = new(_allocator) AWSServerSocket(&acceptData,
                                                                    _socketCleanupHandler,
                                                                    _logger);
...
bool AWSListeningSocket::handleConnectEvent(ESFFlag *isRunning, ESFLogger *logger)
{
    if (_logger->isLoggable(ESFLogger::Error))
    {
        _logger->log(ESFLogger::Error, __FILE__, __LINE__,
...
bool AWSListeningSocket::handleReadableEvent(ESFFlag *isRunning, ESFLogger *logger)
{
    if (_logger->isLoggable(ESFLogger::Error))
    {
        _logger->log(ESFLogger::Error, __FILE__, __LINE__,
...
bool AWSListeningSocket::handleWritableEvent(ESFFlag *isRunning, ESFLogger *logger)
{
    if (_logger->isLoggable(ESFLogger::Error))
    {
        _logger->log(ESFLogger::Error, __FILE__, __LINE__,
...
bool AWSListeningSocket::handleErrorEvent(ESFError errorCode, ESFFlag *isRunning, ESFLogger *logger)
{
    if (_logger->isLoggable(ESFLogger::Error))
    {
        char buffer[100];
...
bool AWSListeningSocket::handleEndOfFileEvent(ESFFlag *isRunning, ESFLogger *logger)
{
    if (_logger->isLoggable(ESFLogger::Error))
    {
        _logger->log(ESFLogger::Error, __FILE__, __LINE__,
...
bool AWSListeningSocket::handleIdleEvent(ESFFlag *isRunning, ESFLogger *logger)
{
    if (_logger->isLoggable(ESFLogger::Error))
    {
        _logger->log(ESFLogger::Error, __FILE__, __LINE__,
...
const char *AWSListeningSocket::getName() const
{
    return "AWSListeningSocket";
}
