...
ESFSmartPointerDebugger::Instance() {
    return &_Instance;
}

bool ESFSmartPointerDebugger::Initialize() {
    return true;
}

bool ESFSmartPointerDebugger::Destroy() {
    return true;
}
...
ESFSmartPointerDebugger::ESFSmartPointerDebugger() :
    _references(true, &AddressComparator, ESFSystemAllocator::GetInstance(), &SmartPointerDebuggerMutex) {
}
