 ...
 * (http://sourceforge.net/projects/sparrowhawk/).vvv
 *
 *    $Author: blattj $
...
ESFSystemAllocator *ESFSystemAllocator::GetInstance() { return &_Allocator; }

ESFSystemAllocator::ESFSystemAllocator() {}

ESFSystemAllocator::~ESFSystemAllocator() {}

void *ESFSystemAllocator::allocate(ESFUWord size) {
  if (0 == size) {
    return 0;
  }
...
ESFUWord ESFSystemAllocator::getOverhead() { return ESF_UWORD_C(0); }

ESFError ESFSystemAllocator::initialize() { return ESF_SUCCESS; }

ESFError ESFSystemAllocator::destroy() { return ESF_OPERATION_NOT_SUPPORTED; }

ESFError ESFSystemAllocator::isInitialized() { return ESF_SUCCESS; }
