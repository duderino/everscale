...
ESFSocketAddress::ESFSocketAddress() : _magic(0) {
#ifdef HAVE_MEMSET
...
ESFSocketAddress::ESFSocketAddress(const char *dottedIp, ESFUInt16 port,
...
ESFSocketAddress &ESFSocketAddress::operator=(const ESFSocketAddress &address) {
#ifdef HAVE_MEMCPY
  memcpy(&_address, &address._address, sizeof(Address));
#else
#error "memcpy equivalent is required"
...
ESFSocketAddress::Address *ESFSocketAddress::getAddress() { return &_address; }
...
bool ESFSocketAddress::isValid() { return ESF_MAGIC == _magic; }
