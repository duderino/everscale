...
public:
    ...
    inline ESFEmbeddedListElement *getNext() {
        return _next;
    }

    inline const ESFEmbeddedListElement *getNext() const {
        return _next;
    }

    inline void setNext(ESFEmbeddedListElement *next) {
        _next = next;
    }

    inline ESFEmbeddedListElement *getPrevious() {
        return _previous;
    }

    inline const ESFEmbeddedListElement *getPrevious() const {
        return _previous;
    }
