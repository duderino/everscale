...
public:
     ...
     * @return The first element in the list or NULL if the list has no elements
     */
    inline const ESFEmbeddedListElement *getFirst() const {
        return _head;
    }

    /** Remove and return the first element in the list.  This does not call the element's
     *  cleanup handler.
     *
     * @return The first element in the list or NULL if the list has no elements.
     */
     ...
     * @return The last element in the list or NULL if the list has no elements
     */
    inline const ESFEmbeddedListElement *getLast() const {
        return _tail;
    }

    /** Remove and return the last element in the list.  This does not call the element's
     *  cleanup handler.
     *
     * @return The last element in the list or NULL if the list has no elements
     */
    ...
    /** Remove an element from an arbitrary position in the list.  This does not call the
