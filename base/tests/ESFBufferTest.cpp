...
ESFBufferTest::ESFBufferTest()
    : _capacity(BufferSize),
      _rand(),
      _buffer((unsigned char *)ESFSystemAllocator::GetInstance()->allocate(
                  BufferSize),
              BufferSize) {}

ESFBufferTest::~ESFBufferTest() {}

void ESFBufferTest::fillTest(ESTFResultCollector *collector,
...
void ESFBufferTest::drainTest(ESTFResultCollector *collector,
                              unsigned int startPosition,
                              unsigned int endPosition) {
...
bool ESFBufferTest::setup() { return true; }

bool ESFBufferTest::tearDown() { return true; }
