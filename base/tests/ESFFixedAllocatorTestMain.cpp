...
int main() {
    ESFFixedAllocatorTestPtr fixedAllocatorTest = new ESFFixedAllocatorTest();

    ESTFConcurrencyDecoratorPtr fixedAllocatorDecorator = new ESTFConcurrencyDecorator(fixedAllocatorTest, 3);
