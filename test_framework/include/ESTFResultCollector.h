...
public:
    ...
    public:
         ...
         */
        Result( ResultType type, const char *description,
            const char *file, int line, Thread::ThreadId threadId,
            Date date );
	...
	std::ostream &print( std::ostream &output ) const;
         ...
         */
        inline ResultType getType() const
        {
            return _type;
        }
 ...
 *  @ingroup test
 */
inline std::ostream &operator<<( std::ostream &out, const ResultCollector &collector )
{
