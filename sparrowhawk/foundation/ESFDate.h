...
public:
     ...
     */
    inline ESFUInt32 getSeconds() const {
        return _seconds;
    }
     ...
     */
    inline void setSeconds(ESFUInt32 seconds) {
        _seconds = seconds;
    }
     ...
     */
    inline ESFUInt32 getMicroSeconds() const {
