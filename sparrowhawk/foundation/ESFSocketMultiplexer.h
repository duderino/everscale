 ...
 *  @brief A command that delegates i/o readiness events to multiple ESFMultiplexedSockets
 *
...
/** A command that delegates i/o readiness events to multiple ESFMultiplexedSockets.  The
 *  command can be run in the current thread of control or run by an ESFCommandThread or
 *  even in an ESFThreadPool.
 *
 * @ingroup network
 */
...
public:
     ...
     */
    virtual ESFError addMultiplexedSocket(ESFMultiplexedSocket *multiplexedSocket) = 0;
