...
#define ESF_BUDDY_ALLOCATOR_TEST_H
...
/**	ESTFBuddyAllocatorTest is the unit test for ESFBuddyAllocator.
 *
 *  @ingroup foundation_test
 */
class ESFBuddyAllocatorTest: public ESTFComponent {
public:
    /**	Constructor.
     */
    ESFBuddyAllocatorTest();

    /** Destructor. */
    virtual ~ESFBuddyAllocatorTest();
...
private:
    ...
    ESTFRand _rand;
    ESFBuddyAllocator _allocator;
};

DEFINE_ESTF_OBJECT_PTR(ESFBuddyAllocatorTest,ESTFComponent)

#endif                                 /* ! ESF_BUDDY_ALLOCATOR_TEST_H */
