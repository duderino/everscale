...
int main() {
	ESFBuddyAllocatorTestPtr buddyAllocatorTest = new ESFBuddyAllocatorTest();

	ESTFConcurrencyDecoratorPtr buddyAllocatorDecorator =
			new ESTFConcurrencyDecorator(buddyAllocatorTest, 3);
